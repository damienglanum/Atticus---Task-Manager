  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto px-2 pb-2">
        <div className="mb-1.5 flex items-center justify-between gap-2 pt-1">
      ...
      {/*
        Settings lives here and nowhere else. The window header has the room for
        a second gear, and putting one there would mean two controls announcing
        the same name — the nuisance already noted beside the empty state below.
      */}
